...
- AI w MVP jest narzędziem redakcyjnym działającym w tle, a nie obowiązkowym publicznym czatem ani wyszukiwarką pytań. Istniejący prototyp OpenAI pozostaje eksperymentem; Mistral EU jest drugim dostawcą pilotażowym do klasyfikacji, wyboru kandydatów i embeddings. Użytkownik przegląda boxy, nitki redakcji i autoryzowanych autorów oraz kontekst boxa z zapisanej bazy. Szczegóły: `docs/AI_PROVIDER_PLAN.md`.
