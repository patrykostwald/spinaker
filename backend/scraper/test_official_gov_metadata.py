...
@pytest.mark.parametrize("key", ["cyfryzacja", "edukacja", "gddkia", "gdos", "gis", "gios", "gitd", "gugik", "infrastruktura", "kgpsp", "kis", "klimat", "kowr", "kultura", "map", "mon", "msz", "nauka", "ncbr", "paa", "prokuratoria", "rars", "rolnictwo", "rodzina", "rozwoj", "sprawiedliwosc", "sport", "wug", "zdrowie"])
