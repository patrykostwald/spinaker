...
@pytest.mark.parametrize("key", ["cyfryzacja", "edukacja", "gis", "gios", "infrastruktura", "klimat", "kowr", "kultura", "map", "mon", "msz", "nauka", "rars", "rolnictwo", "rodzina", "rozwoj", "sprawiedliwosc", "sport", "zdrowie"])
