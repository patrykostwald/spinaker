...
@pytest.mark.parametrize("key", ["cyfryzacja", "edukacja", "gddkia", "gdos", "gif", "gis", "gios", "gitd", "gugik", "infrastruktura", "kgpsp", "kis", "klimat", "kowr", "kultura", "map", "mon", "msz", "nauka", "ncbr", "nfosigw", "paa", "prokuratoria", "rars", "rolnictwo", "rodzina", "rozwoj", "rpp", "sprawiedliwosc", "sport", "udsc", "urpl", "uzp", "wug", "zdrowie"])
