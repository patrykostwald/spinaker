...
@pytest.mark.parametrize("key", ["cyfryzacja", "edukacja", "gdos", "gis", "gios", "gugik", "infrastruktura", "kis", "klimat", "kowr", "kultura", "map", "mon", "msz", "nauka", "ncbr", "paa", "prokuratoria", "rars", "rolnictwo", "rodzina", "rozwoj", "sprawiedliwosc", "sport", "wug", "zdrowie"])
