...
@pytest.mark.parametrize("key", ["cyfryzacja", "edukacja", "gdos", "gis", "gios", "infrastruktura", "kis", "klimat", "kowr", "kultura", "map", "mon", "msz", "nauka", "ncbr", "paa", "rars", "rolnictwo", "rodzina", "rozwoj", "sprawiedliwosc", "sport", "zdrowie"])
