...
@pytest.mark.parametrize("key", ["cyfryzacja", "edukacja", "gddkia", "gdos", "gif", "gis", "gios", "gitd", "gugik", "infrastruktura", "kas", "kgpsp", "kis", "klimat", "kontaktoze", "kowr", "kultura", "map", "mon", "msz", "nauka", "ncbr", "nfosigw", "paa", "priorytety", "prokuratoria", "rars", "rolnictwo", "rodzina", "rozwoj", "rpp", "sluzby_specjalne", "sprawiedliwosc", "sport", "udsc", "urpl", "uzp", "wug", "zdrowie"])
