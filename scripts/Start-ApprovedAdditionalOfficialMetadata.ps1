...
foreach ($sourceKey in @("cyfryzacja", "kultura", "rozwoj", "nauka", "gis", "gios", "rars", "kowr", "rodzina", "sport", "gdos", "kis", "ncbr", "paa", "wug", "gugik", "prokuratoria", "gddkia", "kgpsp", "gitd", "udsc", "uzp", "nfosigw")) {
