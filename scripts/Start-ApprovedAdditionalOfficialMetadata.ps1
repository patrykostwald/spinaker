...
foreach ($sourceKey in @("cyfryzacja", "kultura", "rozwoj", "nauka", "gis", "gios", "rars", "kowr", "rodzina", "sport", "gdos", "kis", "ncbr", "paa", "wug", "gugik", "govtech", "prokuratoria", "gddkia", "kgpsp", "gitd", "udsc", "uzp", "nfosigw", "urpl", "gif", "rpp", "kas", "priorytety", "kontaktoze", "sluzby_specjalne")) {
