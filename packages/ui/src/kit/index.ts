...
// Волна 1
export { NewsCard, type NewsCardProps, type NewsCardSize } from "./NewsCard"; // R3
// R1 иконки и контролы, R2 кнопки и дропдаун, R4 примитивы движения — дописываются при мерже
