...
export { MaterialDetails } from "./components/MaterialDetails";
export { MaterialTimeline } from "./components/MaterialTimeline";
export { MaterialReactions } from "./components/MaterialReactions";
export { MaterialWaterfall } from "./components/MaterialWaterfall";
...
export { TopTenRedakcji } from "./components/TopTenRedakcji";
export { TematDnia } from "./components/TematDnia";
export { TwojePaski } from "./components/TwojePaski";
...
export { AIResearch } from './components/AIResearch';
