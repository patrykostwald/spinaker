...
export default function PrivacyPage() {
  return <InfoPage eyebrow="INFORMACJE" title="Prywatność i cookies" lead="To robocza informacja dla pilotażu. Przed publicznym uruchomieniem uzupełnimy ją o dane administratora, kanał kontaktu, okresy przechowywania i aktualną listę dostawców.">
