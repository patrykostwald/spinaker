...
export default function SupportPage() {
  ...
  return <InfoPage eyebrow="WSPARCIE" title="Wesprzyj spin.clinic" lead="Dobrowolne wsparcie pomaga rozwijać katalog źródeł, weryfikację dostępu i narzędzia redakcyjne.">
