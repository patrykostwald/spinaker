...
export default function TermsPage() {
  return <InfoPage eyebrow="INFORMACJE" title="Zasady korzystania" lead="spin.clinic porządkuje i łączy odnośniki do materiałów źródłowych. Nie zastępuje publikacji wydawcy ani samodzielnej oceny czytelnika.">
    ...
    <section><h2>Klinika spinu</h2><p>Diagnozy postów polityków przygotowuje i publikuje automatycznie AI — każda jest tak oznaczona, z nazwą modelu i wersją instrukcji. Treści diagnoz nikt nie redaguje; zespół może jedynie wstrzymać publikację. Diagnoza opisuje komunikat — techniki perswazji i zgodność twierdzeń ze źródłami — a nie osobę. Ustalenia o faktach mają linki do źródeł; bez źródła twierdzenie jest oznaczone jako „nie do sprawdzenia”. Zgłoszenia dotyczące diagnoz przyjmujemy pod adresem <a href="mailto:admin@spin.clinic">admin@spin.clinic</a>; po zgłoszeniu prawnym diagnoza może zostać ukryta.</p></section>
    <section><h2>Czego portal nie robi</h2><p>Nie ocenia osób, nie wydaje automatycznych werdyktów „prawda” lub „fałsz”, nie publikuje treści modeli bez wyraźnego oznaczenia, że przygotowało je AI, i nie zastępuje oryginalnej publikacji. Jeśli czegoś nie wiemy, pokazujemy brak danych zamiast dopowiadać.</p></section>
