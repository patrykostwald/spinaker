...
| NIK — oficjalny RSS (`nik.gov.pl/rss/`) | `https://www.nik.gov.pl/rss/` | NIK wskazuje, że korzystanie z materiałów serwisu nie wymaga zgody NIK, z wyjątkiem osobno oznaczonych materiałów osób trzecich; zachowujemy wskazanie źródła i nie pobieramy takich elementów. | Pilot: metadane RSS co godzinę, co najmniej 3 s między żądaniami, **24 żądania/dzień**. | Tytuł, URL, data i feed summary: tak. HTML artykułu, archiwum, obrazy, wideo, snapshot i trening: nie. |
