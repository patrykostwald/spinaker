...
| ABW, rekord 382 | `https://www.abw.gov.pl/dokumenty/rss/24-rss-748.rss` | aktywne, karta RSS v1, limit 24/dzień; pierwszy import: 10 boxów | [strona usługi RSS ABW](https://www.abw.gov.pl/pl/rss) wskazuje wprost dystrybucję aktualności i komunikatów w RSS, z tytułem, krótkim opisem i linkiem; karta pozostaje wyłącznie dla tych metadanych |
| BIP Torunia, rekord 579 | `https://bip.torun.pl/rss` | aktywne, karta RSS v1, limit 24/dzień; pierwszy import: 100 boxów | [warunki BIP Torunia](https://bip.torun.pl/artykul/7/1/name) obejmują wprost informację udostępnioną w tym BIP oraz wymagają wskazania źródła, czasu i przetworzenia |
