...
- Płatny dostawca AI na MVP poprzez wymienny adapter. Własna baza i ocenione powiązania pozostają u nas. Nie zakładamy eksportu pamięci ani wag modelu dostawcy. Kontrola kosztu, limit prób i jawne źródła odpowiedzi.
...
9. AI-01 — dostawca płatny przez adapter, wyszukiwanie i szkice do 15 powiązanych materiałów. Odbiór: wyłącznie istniejące i dozwolone ID boxów, daty i pochodzenie, brak fikcyjnych linków, granica kosztu/liczby prób, brak automatycznej publikacji politycznych ocen. Szkice redakcyjne zatwierdza człowiek.
